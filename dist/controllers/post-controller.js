...
exports.destroy = exports.update = exports.create = exports.getOne = exports.posts = void 0;
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validationError, error, body, title, content, imageLink, authorId, error, post, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                body = req.body;
                title = body.title, content = body.content, imageLink = body.imageLink;
...
var update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validationError, error, body, title, content, imageLink, id, error, post, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
